...
class CustomMarker extends React.Component {
  ...
  routing = () => {
    ...
    const promise = fetch(`https://route.api.here.com/routing/7.2/calculateroute.json?waypoint0=${this.props.position}&waypoint1=${this.props.wastePoint}&mode=fastest%3Bcar&app_id=${hereCredentials.id}&app_code=${hereCredentials.code}`)
      .then(x => x.json())
